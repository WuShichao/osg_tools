...
export LD_LIBRARY_PATH=${HOME}/opt/lalsuite_master/lib:/usr/lib64:/usr/lib:$LIBRARY_PATH
...
export LD_LIBRARY_PATH=${HOME}/opt/lscsoft/lalsuite_master/lib:/usr/lib64:$LIBRARY_PATH
