...
export PATH=${PATH}:${HOME}/src/lscsoft/bayeswave/trunk/postprocess
export PATH=${PATH}:${HOME}/src/lscsoft/bayeswave/trunk/postprocess/skymap
...
export PYTHONPATH=${PYTHONPATH}:${HOME}/src/lscsoft/bayeswave/trunk/postprocess
export PYTHONPATH=${PYTHONPATH}:${HOME}/src/lscsoft/bayeswave/trunk/postprocess/skymap
export PYTHONPATH=${PYTHONPATH}:${HOME}/src/lscsoft/bayeswave/trunk/utils
